...
public class SummaryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		String formattedCardNumber = fullCardNumber.substring(0, 4) + " - "
				+ fullCardNumber.substring(4, 8) + " - " + fullCardNumber.substring(8, 12) + " - "
				+ fullCardNumber.substring(12);
		...
		String selectedColor = listOfCards.substring(listOfCards.indexOf(";") + 1,
				listOfCards.indexOf(";") + 2);
